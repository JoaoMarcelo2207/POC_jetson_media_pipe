...
def calculate_measures_distances(landmarks):
    ...
    mean_m14 = mean_point([landmarks[61], landmarks[291]])
    m14 = euclidean_distance(mean_m14, landmarks[0])

    # Mouth mean (49,55) ↔ lower lip (58 → mp mean(61,291)↔17)
    mean_m15 = mean_point([landmarks[61], landmarks[291]])
    m15 = euclidean_distance(mean_m15, landmarks[17])

    # Mouth mean (49,55) ↔ internal lower lip (67 → mp mean(61,291)↔14)
    mean_m16 = mean_point([landmarks[61], landmarks[291]])
    m16 = euclidean_distance(mean_m16, landmarks[14])

    # Mouth mean (49,55) ↔ internal mouth top (63 → mp mean(61,291)↔13)
    mean_m17 = mean_point([landmarks[61], landmarks[291]])
    m17 = euclidean_distance(mean_m17, landmarks[13])
