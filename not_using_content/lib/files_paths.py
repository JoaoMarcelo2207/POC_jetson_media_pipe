...
DATASET_SEED_LEGENDA = os.path.join("..", "Dataset", "REF-Gold-Legenda")
DATASET_SEED_ALEATORIO = os.path.join("..", "Dataset", "REF-Gold-Aleatorio")
...
VIDEO_SOURCE_LEGENDA = os.path.join("..", "Video-Source", "in_REF-Gold-Legenda")
VIDEO_SOURCE_ALEATORIO = os.path.join("..", "Video-Source", "in_REF-Gold-Aleatorio")